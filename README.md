local SimpleGPOUi = loadstring(game:HttpGet("https://raw.githubusercontent.com/naypramx/Ui__Project/Script/GPOUi"))()
...
local Tab = Main:Tap('DA HOOD')
local page = Tab:page()

page:Button("BANK",function()
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-442.763336, 22.9912872, -284.712708, -0.00608347962, 4.07028047e-08, -0.999981523, -1.43483669e-08, 1, 4.0790848e-08, 0.999981523, 1.45962513e-08, -0.00608347962)
end)

page:Button("GUNSHOP2",function()
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(483.154694, 48.0685158, -622.357971, -0.997625589, -4.98435115e-09, 0.0688711926, -9.78651649e-09, 1, -6.93893583e-08, -0.0688711926, -6.98986113e-08, -0.997625589)
end)

page:Button("GUNSHOP1",function()
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-576.113098, 8.31280613, -736.281799, 0.012269848, -1.21849794e-07, -0.999924719, -2.97285307e-08, 1, -1.22223753e-07, 0.999924719, 3.12259587e-08, 0.012269848)
end)

page:Button("CASINO",function()
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-863.028259, 21.6490192, -168.005493, 0.999946296, 5.1987219e-09, 0.0103618391, -4.45346382e-09, 1, -7.19464239e-08, -0.0103618391, 7.18964159e-08, 0.999946296)
end)

page:Button("ROOMADDMIN",function()
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-871.435608, -38.4011879, -574.459534, 0.999969125, -1.09846416e-08, -0.00785945915, 1.1319929e-08, 1, 4.26158273e-08, 0.00785945915, -4.27034799e-08, 0.999969125)
end)

page:Button("CASHSERVER",function()
loadstring(game:HttpGet('https://raw.githubusercontent.com/GS21Official/-ToolsScript/main/!Tools%20script%20page'))() 
end)

page:Button("DROP MONY",function()
